...
ax1.yaxis.set_ticks(range(0, 8, 2))
...
ax3.yaxis.set_ticks(range(0, 125, 25))
...
plt.savefig('Corrections.svg', format='svg', dpi=1200)
...
ax1.yaxis.set_ticks(range(0, 350, 50))
ax1.xaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(5))
...
ax2.xaxis.set_ticks(range(370, 400, 5))
ax2.yaxis.set_ticks(range(0, 350, 50))
ax2.xaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(5))
...
ax3.fill_between(blank.wavelengths, blank.cor_data, fluor.cor_data,  em_limits_bool,
                 color="#ffe38c", alpha=0.8)
ax3.legend(["Photons Emitted"], fontsize = 12)
ax3.set_xlim(370, 550)
ax3.set_ylim(-0.5, 4.5)
ax3.xaxis.set_ticks(range(350, 560, 50))
ax3.yaxis.set_ticks(range(0, 5, 1))
ax3.xaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(5))
