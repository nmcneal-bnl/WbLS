...
fig1.suptitle("Raw and Corrected Spectra of PPO in Ethanol\n",
              weight='semibold', y=.99, fontsize=20)
ax1.set_title("Initial Raw Emission Spectrum", fontsize = 15)
ax2.set_title("Total Correction Factor", fontsize = 15)
ax3.set_title("Final Corrected Emission Spectrum", fontsize = 15)


ax1.plot(data1.wavelengths, data1.raw_data/1000,"#d60027",lw=2)
ax1.axhline(y=0, xmin=0, xmax=1, linewidth=1, color = 'k')
ax1.set_ylabel("Emission Intensity [a.u.]", fontsize = 12)
ax1.xaxis.set_ticks(range(300, 560, 25))
ax1.yaxis.set_ticks(range(0, 7, 3))
ax1.xaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(5))
ax1.yaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(3))

corrections = PTICorr.get_corrections(data1)
ax2.plot(data1.wavelengths, corrections, "#268a47",lw=2)
ax2.set_ylabel("Magnitude", fontsize = 12)
ax2.xaxis.set_ticks(range(300, 560, 25))
...
ax3.plot(data1.wavelengths, data1.cor_data/1000, "#3857ff",lw=2)
ax3.set_ylabel("Emission Intensity [a.u.]", fontsize = 12)
ax3.xaxis.set_ticks(range(300, 560, 25))
ax3.yaxis.set_ticks(range(0, 150, 50))
ax3.xaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(5))
ax3.yaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(5))
...
plt.show()
##fig1.savefig('Corrections.jpg', dpi=300)

##'''Showing an example of the quantum yield calculation'''
##fig2 = plt.figure(figsize = (45,30))
##ax1 = plt.subplot2grid((2,2), (0,0), colspan = 2)
##ax2 = plt.subplot2grid((2,2), (1,0))
##ax3 = plt.subplot2grid((2,2), (1,1))
##
##fig2.suptitle("Corrected Spectra of LAB and bisMSB in LAB",
##              weight='semibold', y=0.98, fontsize=20)
##ax1.set_title("Comparison of Fully Corrected Spectra", fontsize=15)
##ax2.set_title("Absorption Wavelength Range", fontsize=15)
##ax3.set_title("Emission Wavelength Range", fontsize=15)
##
...
##ax1.xaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(5))
##ax1.yaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(4))
##
##
...
##ax2.xaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(5))
##ax2.yaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(4))
##
...
##ax3.xaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(5))
##ax3.yaxis.set_minor_locator(mpl.ticker.AutoMinorLocator(4))
##
##
...
##plt.subplots_adjust(hspace=0.3)
##
####fig2.savefig('Quantum Yield Example.jpg', dpi=300)
##plt.show()
